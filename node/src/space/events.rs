...
impl EventKind {
    ...
    pub fn kind(&self) -> u32 {
        match self {
            ...
            EventKind::MutateSecret => 100006,
            EventKind::DeleteSecret => 100007,
            EventKind::MutateTable => 100008,
            EventKind::DeleteTable => 100009,
            EventKind::MutateRow => 100010,
            EventKind::DeleteRow => 100011,
        }
    }
}
...
impl FromSql for EventKind {
    fn column_result(value: rusqlite::types::ValueRef<'_>) -> rusqlite::types::FromSqlResult<Self> {
        ...
        match kind {
            ...
            100006 => Ok(EventKind::MutateSecret),
            100007 => Ok(EventKind::DeleteSecret),
            100008 => Ok(EventKind::MutateTable),
            100009 => Ok(EventKind::DeleteTable),
            100010 => Ok(EventKind::MutateRow),
            100011 => Ok(EventKind::DeleteRow),
